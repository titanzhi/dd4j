...
public final class HttpParams {
	...
	public static HttpParams copy(final HttpParams params) {
		return new HttpParams().setAllowUserInteraction(params.isAllowUserInteraction())
				.setConnectTimeout(params.getConnectTimeout()).setSocketTimeout(params.getSocketTimeout())
				.setReadTimeout(params.getReadTimeout()).setChunkSize(params.getChunkSize())
				.setFollowRedirects(params.isFollowRedirects());
	}

	@Override
	public String toString() {
		return "HttpParams [allowUserInteraction=" + allowUserInteraction + ", connectTimeout=" + connectTimeout
				+ ", socketTimeout=" + socketTimeout + ", readTimeout=" + readTimeout + ", chunkSize=" + chunkSize
				+ ", followRedirects=" + followRedirects + ", proxy=" + proxy + ", sslContext=" + sslContext
